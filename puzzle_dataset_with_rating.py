...
from dataset.build_sudoku_dataset_with_rating import PuzzleDatasetMetadataWithRating as PuzzleDatasetMetadata
...
class PuzzleDataset(IterableDataset):
    def __init__(self, config: PuzzleDatasetConfig, split: str = "train"):
        ...
        for dataset_path in config.dataset_paths:
            ...
            if prev_seq_len is None:
                ...
                prev_pad_rating_id = current_metadata.pad_rating_id
                ...
                assert prev_pad_rating_id == current_metadata.pad_rating_id
        ...
        self.metadata = PuzzleDatasetMetadata(
            ...
            pad_id=prev_pad_id,
            pad_rating_id=prev_pad_rating_id,
    ...
    def _collate_batch(self, batch):
        ...
        # Convert pad rating IDs to -1
        if self.metadata.pad_rating_id is not None and "ratings" in batch:
            batch["ratings"][batch["ratings"] == self.metadata.pad_rating_id] = -1
        ...
        for set_i, (set_name, dataset) in enumerate(self._data.items()):  # type: ignore
            ...
            while start_index < total_examples:
                ...
                batch = self._collate_batch({
                    ...
                    "ratings": dataset["ratings"][local_start: local_end],
        ...
        for set_name, dataset in self._data.items():  # type: ignore
            ...
            while start_index < group_order.size:
                ...
                batch = self._collate_batch({
                    ...
                    "ratings": dataset["ratings"][batch_indices],
